...
\date{Q4 2020}
%% Mine
\newcommand{\buildrootLatestVersion}{2020.11-rc3}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Updated every 3 months {\small current version is \buildrootLatestVersion}
...
\begin{frame}[fragile]
  ...
  \footnotesize
  \verbatiminput{../seminar-scripts/to-include-in-output/boot-rootfs.sh}
\end{frame}
\only<handout> {
